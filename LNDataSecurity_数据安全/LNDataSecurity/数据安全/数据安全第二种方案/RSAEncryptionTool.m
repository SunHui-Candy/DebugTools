...
// 公钥/私钥标签
#define kPublicKeyTag			"com.CoderLN.sample.publickey"
#define kPrivateKeyTag			"com.CoderLN.sample.privatekey"

static const uint8_t publicKeyIdentifier[]		= kPublicKeyTag;
static const uint8_t privateKeyIdentifier[]		= kPrivateKeyTag;

@interface RSAEncryptionTool() {
...
@implementation RSAEncryptionTool

+ (instancetype)sharedRSAEncryptionTool {
    static id instance;
